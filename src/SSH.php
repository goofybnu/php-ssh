...
namespace WebAppBrCom\SecureShell;
...
class SSH
{
    ...
    /**
     * Método responssável por autenticar a conexão utilizando usuário e senha
     * @param string $user 
     * @param string $pass 
     * @return boolean
     */
    ...
    /**
     * Método responsável por removar a conexão atual
     * @return boolean 
     */
    ...
    /**
     * Método responsável por executar comando SSH
